...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>rails3-devise-rspec-cucumber/spec/controllers/home_controller_spec.rb at master · RailsApps/rails3-devise-rspec-cucumber · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/788200?s=400" property="og:image" /><meta content="RailsApps/rails3-devise-rspec-cucumber" property="og:title" /><meta content="https://github.com/RailsApps/rails3-devise-rspec-cucumber" property="og:url" /><meta content="rails3-devise-rspec-cucumber - An example Rails 3.2 app with Devise and RSpec and Cucumber. With a tutorial." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="B02238F6:7ED5:618DE0:537B16DB" name="octolytics-dimension-request_id" />
...
<meta content="FIkJvqZyCybZnMfWTGZNczR+iIqJEXwy3fXpxn+JUxLQxaoejMm1ZmAvhpKgUxgYUH9boAaovsGUtepJGvxjiQ==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2FRailsApps%2Frails3-devise-rspec-cucumber%2Fblob%2Fmaster%2Fspec%2Fcontrollers%2Fhome_controller_spec.rb">Sign in</a>
    </div>
...
<a href="/RailsApps/rails3-devise-rspec-cucumber/blob/0ec21876ff2882d8433a04badeb5def651bfbfb0/spec/controllers/home_controller_spec.rb" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:bf8f3a66271b0aeb359bfce5a5ce20a2 -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/RailsApps/rails3-devise-rspec-cucumber/blob/master/spec/controllers/home_controller_spec.rb"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/RailsApps/rails3-devise-rspec-cucumber/blob/rails-3-0-7/spec/controllers/home_controller_spec.rb"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/RailsApps/rails3-devise-rspec-cucumber/blob/rails-3-0-8/spec/controllers/home_controller_spec.rb"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/RailsApps/rails3-devise-rspec-cucumber/tree/rails3.0.8/spec/controllers/home_controller_spec.rb"
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/RailsApps/rails3-devise-rspec-cucumber/tree/rails3.0.7/spec/controllers/home_controller_spec.rb"
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/RailsApps/rails3-devise-rspec-cucumber/raw/master/spec/controllers/home_controller_spec.rb" class="button minibutton " id="raw-url">Raw</a>
            <a href="/RailsApps/rails3-devise-rspec-cucumber/blame/master/spec/controllers/home_controller_spec.rb" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/RailsApps/rails3-devise-rspec-cucumber/commits/master/spec/controllers/home_controller_spec.rb" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L12" rel="#L12">12</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="nb">require</span> <span class="s1">&#39;spec_helper&#39;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="n">describe</span> <span class="no">HomeController</span> <span class="k">do</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'>&nbsp;&nbsp;<span class="n">describe</span> <span class="s2">&quot;GET &#39;index&#39;&quot;</span> <span class="k">do</span></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">it</span> <span class="s2">&quot;should be successful&quot;</span> <span class="k">do</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">get</span> <span class="s1">&#39;index&#39;</span></div><div class='line' id='LC8'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="n">response</span><span class="o">.</span><span class="n">should</span> <span class="n">be_success</span></div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC10'>&nbsp;&nbsp;<span class="k">end</span></div><div class='line' id='LC11'><br/></div><div class='line' id='LC12'><span class="k">end</span></div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.03341s from github-fe125-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
